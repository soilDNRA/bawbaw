...
bawbaw_TOC_50to59 <- read_table2("TOC_results/2018-07-02_Baw_Baw_50to59_diluted_1to20.txt", skip = 10, col_types = cols_only(`Type`=col_character(),`Anal.`=col_character()))
