...
#levation_levels <- c("200","300","500","600","800","900","1000","1100","1200","1300","1400","1500") # define factor levels for elevation, to be used with parse_factor
bawbaw_TOC_means$mean_ug_TOC_per_g_soil <- round(bawbaw_TOC_means$mean_ug_TOC_per_g_soil, 1) # round to 1 decimal
...
NC_flextable <- compose(NC_flextable, i = ~ total_NO3_per_g_soil_ug <2.1, j = "total_NO3_per_g_soil_ug", 
  value = as_paragraph("<",
                       ...
                       as_chunk("*", props = fp_text(color = "red"))))
