...
```{r dry, echo=FALSE, fig.show = 'hold', out.width = "33%", fig.cap="\\label{fig:dry}Dry sclerophyll forest (low elevation)."}
...
Labile C was measured as hot water-extractable carbon (HWC) using the method described by @ghaniHotwaterExtractableCarbon2003.
...
NC_flextable <- set_caption(NC_flextable, "Table 1. Labile C as hot water extractable carbon (HWC) and mineral N (NH~4~^+^,NO~3~^-^) per gram soil.")
...
```{r rRNA16S, echo=FALSE, , message = FALSE, fig.cap="*rRNA16S* gene abundance in fresh Baw Baw soil, collected April 2018. Error bars show S.E.M. Efficiency = 100.2%, $R^{2} = 0.99$. \\label{rRNA16Sgraph}"}
