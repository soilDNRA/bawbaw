---
title: "2018-07-20 Nanodrop results (Baw Baw)"
output: pdf_document
---
...
library(tidyverse)
library(kableExtra)
nanodrop <- read_tsv("nanodrop/2018-07-20_nanodrop_report.tsv", skip = 1,col_names = c("#","Sample ID","User name","Date and Time","Nucleic Acid Conc.","Unit","A260","A280","260/280","260/230",	"Sample Type","Factor"))# %>% 
